...
% structfun(@(r) plot(t(1:end-1),r.y(1,1:end-1)),results)
% plot(t,y_ref,'--r');
% legend([legend_entries;'Reference'],'Location','best');
% ylabel('$y$ [m]','Interpreter','latex')
% xlabel('Time [s]','interpreter','latex');
% subplot(4,1,4)
% hold on
% grid on
% structfun(@(r) plot(t,r.kalman_pred(5,:)), results); % Plot the evolution of d_hat
% legend(legend_entries); %; {'Max overhoot'; 'Steady-state error'}
% xlim([0, sim_sec]);
